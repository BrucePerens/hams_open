...
class TestJourneysStories(HamsTransactionCase):
    def test_journeys_realized(self):
        ...
        for f in expected_files:
            self.assertTrue(os.path.exists(os.path.join(base_path, f)), "Journey file %s missing" % f)
    ...
    def test_stories_realized(self):
        ...
        for f in expected_files:
            self.assertTrue(os.path.exists(os.path.join(base_path, f)), "Story file %s missing" % f)
