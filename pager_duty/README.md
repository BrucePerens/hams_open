...
If you are developing or testing this module within the Jules VM environment, please consult [hams_shared/docs/JULES_ISSUES.md](hams_shared/docs/JULES_ISSUES.md) for critical information regarding PostgreSQL socket permissions and Many2many field name sensitivities.
