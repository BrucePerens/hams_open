...
class TestManualUIEnhancements(HamsTransactionCase):
    ...
    def test_01_reading_time_calculation(self):
        ...
        self.assertEqual(article.reading_time, 1, "[!] DIAGNOSTIC FOR AI: Reading time for 200 words should be 1 minute.")

        # ~400 words = 2 minutes
        article.body = "<p>" + "word " * 400 + "</p>"
        self.assertEqual(article.reading_time, 2, "[!] DIAGNOSTIC FOR AI: Reading time for 400 words should be 2 minutes.")

        # Empty body = 0 minutes
        article.body = False
        self.assertEqual(article.reading_time, 0, "[!] DIAGNOSTIC FOR AI: Reading time for empty body should be 0 minutes.")
