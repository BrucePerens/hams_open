...
knowledge.article model. Includes frontend search, feedback, and dynamic TOC.
    ...
    "knowledge_docs": [
        {
            "path": "README.md",
            "name": "Knowledge: Developer Guide",
            "icon": "🛠️",
            "category": "workspace",
        },
        {
        ...
        {
            "path": "docs/journeys/admin_managing_articles.md",
            "name": "Journey: Administrator Managing Articles",
            "icon": "🚀",
            "category": "workspace",
        },
        {
            "path": "docs/journeys/developer_doc_integration.md",
            "name": "Journey: Developer Integrating Documentation",
            "icon": "💻",
            "category": "workspace",
        },
        {
            "path": "docs/journeys/user_browsing_journey.md",
            "name": "Journey: User Browsing the Manual",
            "icon": "👤",
            "category": "workspace",
        },
        {
            "path": "docs/stories/article_view.md",
            "name": "Story: Viewing Manual Articles",
            "icon": "📄",
            "category": "workspace",
        },
        {
            "path": "docs/stories/backend_views.md",
            "name": "Story: Backend Management Views",
            "icon": "⚙️",
            "category": "workspace",
        },
        {
            "path": "docs/stories/doc_installation.md",
            "name": "Story: Automated Documentation Installation",
            "icon": "📦",
            "category": "workspace",
        },
        {
            "path": "docs/stories/feedback.md",
            "name": "Story: Article Feedback",
            "icon": "💬",
            "category": "workspace",
        },
        {
            "path": "docs/stories/hierarchy.md",
            "name": "Story: Article Hierarchy Integrity",
            "icon": "🌲",
            "category": "workspace",
        },
        {
            "path": "docs/stories/search.md",
            "name": "Story: Searching the Manual",
            "icon": "🔍",
            "category": "workspace",
        },
        {
            "path": "docs/stories/toc.md",
            "name": "Story: Dynamic Table of Contents",
            "icon": "📋",
            "category": "workspace",
        },
        {
            "path": "docs/stories/url_generation.md",
            "name": "Story: Dynamic URL Generation",
            "icon": "🔗",
            "category": "workspace",
        },
    ],
    "assets": {
        ...
        # Run by tests/test_knowledge_hoot.py via browser_js().
