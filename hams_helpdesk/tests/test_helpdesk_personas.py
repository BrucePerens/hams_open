...
class TestHelpdeskPersonasUITours(HamsHttpCase):
    ...
    def test_01_crm_user_tour(self):
        self.start_tour("/my/tickets?debug=1", "helpdesk_portal_tour", login="crm_user_tour")

    def test_02_club_user_tour(self):
        self.start_tour("/my/tickets?debug=1", "helpdesk_portal_tour", login="club_user_tour")
