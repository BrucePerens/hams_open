...
* **Controller Interception:** Overrides the `/blog` route to inject the SEO-aware profile object into the QWeb context, seamlessly activating Odoo's interactive "Optimize SEO" UI widget for the profile owner. Verified by `[@ANCHOR: COMM_controller_user_blog_index_seo_override]`.
