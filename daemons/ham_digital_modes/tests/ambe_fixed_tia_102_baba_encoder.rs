...
//! Cross-checks the streaming fixed-point `FrameAnalyzer` (`ambe::fixed::tia_102_baba::encoder`) against the
...
//! `src/ambe/fixed/tia_102_baba/encoder.rs`.

mod common;

use ham_digital_modes::ambe::fixed::mbe_encode as fx_mbe;
use ham_digital_modes::ambe::fixed::tia_102_baba::encoder as fx;
use ham_digital_modes::ambe::float::mbe_encode as fl_mbe;
use ham_digital_modes::ambe::float::tia_102_baba::encoder as fl;
