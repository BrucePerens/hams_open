...
//! Cross-checks `ambe::fixed::ratet27::reconstruct`/`prediction` against their floating-point
...
use ham_digital_modes::ambe::float::ratet27::reconstruct::reconstruct_spectral_amplitudes;
use ham_digital_modes::ambe::float::ratet27::tables::{gain_vector_bits, higher_order_bit_allocation};
...
fn fixed_reconstruct_spectral_amplitudes_matches_float_across_representative_sequences() {
    use ham_digital_modes::ambe::float::ratet27::prediction::INITIAL_L_HAT_PREV;
