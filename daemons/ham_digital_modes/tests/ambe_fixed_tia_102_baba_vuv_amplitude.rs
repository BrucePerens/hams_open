...
//! (`ambe::fixed::tia_102_baba::{vuv, spectral_amplitude}`, `ambe::fixed::mbe_encode::analyze_at_pitch`)
...
use ham_digital_modes::ambe::fixed::tia_102_baba::pitch as fx_pitch;
use ham_digital_modes::ambe::fixed::tia_102_baba::pitch_refinement as fx_ref;
use ham_digital_modes::ambe::float::mbe_encode as fl_mbe;
use ham_digital_modes::ambe::float::tia_102_baba::encoder::FrameAnalysis;
use ham_digital_modes::ambe::float::tia_102_baba::pitch_refinement as fl_ref;
...
fn xi_max_update_and_energy_dependent_function_match_the_equations() {
    use ham_digital_modes::ambe::fixed::tia_102_baba::vuv::{
