...
//! Cross-checks `ambe::fixed::ratet27::enhancement`/`error_estimation` against their floating-point
...
use ham_digital_modes::ambe::fixed::ratet27::enhancement as fixed_enh;
use ham_digital_modes::ambe::fixed::ratet27::error_estimation::{
    estimate_errors_q16, should_mute_frame_q16, should_repeat_frame_q16,
};
use ham_digital_modes::ambe::float::ratet27::enhancement as float_enh;
use ham_digital_modes::ambe::float::ratet27::error_estimation::{estimate_errors, should_mute_frame, should_repeat_frame, FrameErrors};
...
fn adaptive_voicing_threshold_matches_all_three_branches() {
    ...
    for &s_e in &[15000.0, 4.0e8] {
        ...
        let errors_q = ham_digital_modes::ambe::fixed::ratet27::error_estimation::FrameErrorsQ16 {
            total: 2,
