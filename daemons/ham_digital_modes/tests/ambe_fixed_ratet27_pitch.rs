...
//! Cross-checks `ambe::fixed::ratet27::pitch` against `ambe::float::ratet27::pitch` on real speech
...
use ham_digital_modes::ambe::fixed::ratet27::pitch as fx;
use ham_digital_modes::ambe::float::ratet27::pitch as fl;
