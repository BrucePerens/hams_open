...
//! `dvsi_p25fec::wire_format`'s module doc for why relational testing (this investigation's original
...
//! recorded speech), deinterleave via [`super::wire_format::natural_position`], and treat
