...
//! Fixed-point port of `ambe::float::ratet27::reconstruct` -- spectral amplitude reconstruction
...
use crate::ambe::float::ratet27::quantize::higher_order_coefficient_positions;
use crate::ambe::float::ratet27::tables::{block_lengths_for_l, gain_vector_bits, higher_order_bit_allocation};
