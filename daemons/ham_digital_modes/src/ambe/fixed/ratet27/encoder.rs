...
//! [`crate::ambe::float::ratet27::encoder::FrameAnalyzer`]. It buffers PCM, keeps the per-frame
...
//!
//! Verified against the float analyzer in `tests/ambe_fixed_ratet27_encoder.rs`. Measured over all four
