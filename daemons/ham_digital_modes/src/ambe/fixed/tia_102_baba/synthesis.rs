...
//! Fixed-point port of [`super::super::float::tia_102_baba::synthesis`] -- top-level decoder-side
...
/// [`super::super::float::tia_102_baba::synthesis::SynthesisState`]. `s_e`/`tau_m` are `i64` Q16.16,
