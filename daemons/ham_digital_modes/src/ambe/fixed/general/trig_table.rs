...
//! Generated by `examples/ambe_fixed_generate_trig_table.rs` -- do not hand-edit.
//! Quarter-wave sine, Q16.16, 257 entries spanning phase `[0, pi/2]`
//! inclusive, i.e. entry `i` is `round(sin(i * (pi/2) / 256) * 65536)`.

pub const QUARTER_SINE_LEN: usize = 257;
pub const QUARTER_SINE_Q16_16: [i32; 257] = [
