...
//! suite: same as `codec2_1600_encode_raw.rs` but using `EncoderFixed`
//! instead of the float `Encoder`.
//!
//! Usage: `cargo run --example codec2_1600_encode_raw_fixed -- input.raw output.bin`

use ham_digital_modes::codec2_1600::{EncoderFixed, BYTES_PER_FRAME, SAMPLES_PER_FRAME};
