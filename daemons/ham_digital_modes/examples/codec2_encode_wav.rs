...
//! suite: encodes a real 8kHz mono 16-bit WAV with
//! `codec2_3200::floating_reference::Encoder`
...
use ham_digital_modes::codec2_3200::floating_reference::Encoder;
use ham_digital_modes::codec2_3200::{BYTES_PER_FRAME, SAMPLES_PER_FRAME};
