...
//!
//! Regenerate with: `cargo run --release --example ambe_fixed_generate_tia_102_baba_refinement_tables >
...
fn main() {
    ...
    println!("//! Generated by `examples/ambe_fixed_generate_tia_102_baba_refinement_tables.rs` -- do not hand-edit.");
    println!();
