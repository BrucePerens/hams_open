/*!
 * Vendored, self-contained bundle of @noble/ciphers/chacha.js (from @noble/ciphers@2.3.0,
 * MIT License, Paul Miller). Built locally, not fetched pre-built, because
 * the raw npm source uses bare-specifier internal imports
 * (e.g. "@noble/hashes/sha2.js") that a plain browser ESM import() cannot
 * resolve without a bundler or import map -- this file has zero external
 * imports left, verified by grep. Replaces a runtime import from
 * cdn.jsdelivr.net in ham_shack/static/src/js/noise_xx.js and
 * web_transceiver.js (the Noise_XX crypto engine had an unmitigated
 * third-party CDN dependency at the exact point of establishing a secure
 * session -- fixed by self-hosting, matching this repo's existing
 * self-hosting policy for every other runtime dependency).
 *
 * Reproducible build (see external/README.md for the full recipe):
 *   npm install @noble/curves@2.3.0 @noble/hashes@2.3.0 @noble/ciphers@2.3.0
 *   npx esbuild@0.24.0 node_modules/@noble/ciphers/chacha.js --bundle --format=esm --outfile=<this file>
 */
...
var __TESTS = /* @__PURE__ */ Object.freeze({ chachaCore });
