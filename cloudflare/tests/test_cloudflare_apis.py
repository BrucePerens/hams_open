...
class TestCloudflareAPIs(TransactionCase):
    ...
    def test_02_turnstile_secret_fetch(self):
        ...
        with patch("odoo.addons.cloudflare.utils.cloudflare_api.requests.post") as mock_post:
    ...
    def test_03_tunnel_setup(self):
        ...
        with patch("odoo.addons.cloudflare.models.res_config_settings.create_cfd_tunnel") as mock_create, \
             patch("odoo.addons.cloudflare.models.res_config_settings.get_cfd_tunnel_token") as mock_get_token:
    ...
    def test_04_sync_tunnels(self):
        ...
        with patch("odoo.addons.cloudflare.models.tunnel.list_cfd_tunnels") as mock_list:
    ...
    def test_05_delete_tunnel(self):
        ...
        with patch("odoo.addons.cloudflare.models.tunnel.delete_cfd_tunnel") as mock_delete:
