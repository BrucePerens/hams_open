...
3. **Postgres NOTIFY**: The function issues a `NOTIFY` command to the PostgreSQL database. It supports both single invalidations `[@ANCHOR: coherent_cache_signal_single]` and bulk batch updates `[@ANCHOR: coherent_cache_signal_batch]`.
