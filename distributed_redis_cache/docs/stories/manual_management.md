...
Upon installation, the module automatically injects its comprehensive documentation into the Odoo Knowledge app [@ANCHOR: COMM_doc_inject_distributed_redis_cache], ensuring that administrators have immediate access to these instructions.
