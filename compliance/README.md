...
Developers can provision new compliance documents using the `compliance.document` model. To ensure they appear on the `/compliance` portal index page, provision them via `noupdate` XML records.
</enforcement_details>
