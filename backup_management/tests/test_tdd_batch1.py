...
class TestTddBatch1(RealTransactionCase):
    ...
    def test_file_contents(self):
        ...
        # The unit is now generated by infrastructure.py's MANIFEST
        # (matching every other current daemon), not checked in as a
        # standalone .service file.
        infra_path = os.path.join(
            os.path.dirname(base_path), "hams_shared", "tools", "infrastructure.py"
        )
        ...
        self.assertIn("User=odoo", service_content)
